...
Game.appLoginEditScreen.prototype = {
	...
	create: function (game) {
		...
		//* nEED to change this ****
		_this.fullSize = 307056167;//,302978124

		//BBplusplusOffHin//119,374,649 +18,76,72,332,  //95,186,236
		_this.zipFiles = [["Assets1.zip", 981561], ["Assets2.zip", 87770921], ["Assets4.zip", 95186236], ["HindiquestionSounds.zip", 119374649], ["sounds.zip", 3742800]];// old = 3683747
